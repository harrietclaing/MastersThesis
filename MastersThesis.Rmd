...
We make the assumption that the utility functions of all consumers are homogenous (Piketty, 1999) as follows:
$$
...
" A candidate comes into power when she wins every pairwise comparison with country. For analytical convenience, the electorate is assumed continuous choice of competing politicians' types from the this majority-rule process. This range of candidates' types coincides variety of attitudes in the population" Buchholz _et al._ (2005)
